...
{
    int r, c, n;
    int sec=0, min = 0, hour = 0, sp, sum = 0, mt=0, ht=0, st=0;
    //fonts types
    Font font, font1;
    ...
    string ptxt = "GAME PAUSED", ptxt1="Press enter or click mouse\n\t\tbutton to contine";
    //some variables for game
    char ch, arr[9][9], num;
    bool sudokuSolved = false;
    //graphics texts 
    Text rules1, rules2, fin, cont, cont1, text1, text, text2, saveT, saveTx, erTxt, pTxt, pTxt1;
    //rules text
    ...
    pTxt1.setFont(font1); pTxt1.setCharacterSize(34); pTxt1.setFillColor(Color::Black); pTxt1.setStyle(Text::Bold); pTxt1.setString(ptxt1); pTxt1.setPosition(10, 70);
    pTxt.setFont(font); pTxt.setCharacterSize(35); pTxt.setFillColor(Color::Black); pTxt.setStyle(Text::Bold); pTxt.setString(ptxt); pTxt.setPosition(55, 15);
    ...
    n11.setFont(font); n11.setCharacterSize(50); n11.setFillColor(Color::Black); num = arr[0][0]; n11.setString(arr[0][0]);
    ...
    //position
    n99.setPosition(680, 600); n98.setPosition(615, 600); n96.setPosition(485, 600); n94.setPosition(355, 600);
    n93.setPosition(290, 600); n92.setPosition(225, 600); n89.setPosition(680, 535); n87.setPosition(550, 535);
    n86.setPosition(485, 535); n81.setPosition(160, 535); n83.setPosition(290, 535); n85.setPosition(420, 535);
    n82.setPosition(225, 535); n51.setPosition(150, 340); n61.setPosition(152, 405); n62.setPosition(225, 405);
    n63.setPosition(290, 405); n64.setPosition(355, 405); n65.setPosition(420, 405); n78.setPosition(615, 470);
    n79.setPosition(685, 470); n67.setPosition(550, 405); n52.setPosition(225, 340); n73.setPosition(290, 470);
    n66.setPosition(485, 405); n54.setPosition(355, 340); n77.setPosition(550, 470); n56.setPosition(485, 340);
    n55.setPosition(420, 340); n58.setPosition(615, 340); n59.setPosition(680, 340); n68.setPosition(615, 405);
    n74.setPosition(355, 470); n75.setPosition(420, 470); n11.setPosition(145, 70); n12.setPosition(210, 70);
    n13.setPosition(290, 80); n15.setPosition(420, 80); n17.setPosition(550, 80); n18.setPosition(615, 80);
    n21.setPosition(152, 145); n23.setPosition(290, 145); n24.setPosition(355, 145); n25.setPosition(420, 145);
    n26.setPosition(485, 145); n27.setPosition(550, 145); n28.setPosition(615, 145); n29.setPosition(685, 145);
    n31.setPosition(152, 210); n32.setPosition(225, 210); n33.setPosition(290, 210); n34.setPosition(355, 210);
    n35.setPosition(420, 210); n37.setPosition(550, 210); n39.setPosition(680, 210); n42.setPosition(225, 275);
    n43.setPosition(290, 275); n44.setPosition(355, 275); n46.setPosition(485, 275); n47.setPosition(550, 275);
    n48.setPosition(615, 275); n49.setPosition(680, 275); n71.setPosition(152, 470);
    Text s, m, h, cl;
    s.setFont(font1); s.setCharacterSize(50); s.setFillColor(Color::Black); s.setStyle(Text::Bold); s.setPosition(120, 5);
    cl.setFont(font1); cl.setCharacterSize(50); cl.setFillColor(Color::Black); cl.setStyle(Text::Bold);cl.setString(":");
    m.setFont(font1); m.setCharacterSize(50); m.setFillColor(Color::Black); m.setStyle(Text::Bold); m.setPosition(65, 5);
    h.setFont(font1); h.setCharacterSize(50); h.setFillColor(Color::Black); h.setStyle(Text::Bold); h.setPosition(5, 5);
    sf::Event event;
    //game loop// starts the clock
    sf::Clock clock;
    while (window.isOpen())
    {
        mt = min + mt;
        ...
        while (sudokuSolved == false)
        {
            ...
            {
                sf::Clock clock1;
                sf::RenderWindow pause(sf::VideoMode(350, 165), "Game Paused", sf::Style::Titlebar | sf::Style::Close);
                while (pause.isOpen())
                {
                    sf::Event event2;
                    while (pause.pollEvent(event2))
                    {
                        switch (event2.type)
                        {
                        case sf::Event::Closed:
                    ...
                    sf::Time t1 = clock1.getElapsedTime();
                    sp = t1.asSeconds();
                    pause.clear(sf::Color(64, 130, 109));
                    pause.draw(pTxt);
                    pause.draw(pTxt1);
                    pause.display();
            ...
            se = to_string(st); s.setString(se);
            mi = to_string(mt); m.setString(mi);
            hr = to_string(ht); h.setString(hr);
            ...
            window.draw(s); window.draw(h);window.draw(m);cl.setPosition(50, 2);window.draw(cl); 
            cl.setPosition(110, 2); window.draw(cl);
